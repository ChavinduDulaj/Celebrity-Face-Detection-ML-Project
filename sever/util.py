...
class_dict_file = os.path.join(current_dir, "artifacts", "class_dictionary.json")
model_file = os.path.join(current_dir, "artifacts", "saved_model.pkl")
face_cascade_file = os.path.join(current_dir, "opencv", "haarcascades", "haarcascade_frontalface_default.xml")
eye_cascade_file = os.path.join(current_dir, "opencv", "haarcascades", "haarcascade_eye.xml")
...
if __name__ == '__main__':
    ...
    #print(classify_image(None, "C:/Users/ASUS/Desktop/Machine Learning/Celebrity-Face-Detection-ML-Project/sever/test_images/serena1.jpg"))
